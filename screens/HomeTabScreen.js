...
export default function HomeTabScreen({ navigation }) {
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            <Text style={styles.title}>{SCREEN_OPTIONS.HOME.screen_title}</Text>
            <Text style={styles.sub}>Tab · path: /</Text>
            ...
            <Button title="Allergy" onPress={() => go(SCREEN_OPTIONS.ALLERGY.route_name)} />
        </ScrollView>
    );
}
